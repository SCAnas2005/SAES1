<?php 
    $user = $data["userinfo"]; // Récupération des informations utilisateur stockées dans la session
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body> <!-- Inclusion du header commun depuis le chemin stocké en session -->
